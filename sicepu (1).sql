...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jul 2025 pada 12.04
...
(133, 'Pengadu', 'hai', 'Ilham', 'tes123@gmail.com');
...
INSERT INTO `tb_telegram` (`id_telegram`, `id_chat`, `user`) VALUES
('@kjl098', 'kj', 'Ilham');
...
--
ALTER TABLE `pengguna`
  MODIFY `iduser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
